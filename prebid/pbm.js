/* pbm.js v0.0.4 Updated : 2018-01-23 */ ! function(e) {
    ...
    function o(e) {
        ...
        return r.open("GET", "http://54.209.179.140:80/cache?uuid=febf98a2-89ec-4b72-b6c0-424342d866f4", !1), r.withCredentials = "true", u.logTimestamp("Adm is requested"), r.send(null), 200 === r.status ? n = r.responseText : u.logError("Error request adm cache id"), n
    }
